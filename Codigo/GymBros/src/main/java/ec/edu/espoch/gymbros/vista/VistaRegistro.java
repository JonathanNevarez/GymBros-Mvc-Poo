...
import ec.edu.espoch.gymbros.controlador.ControladorRegistro;

public class VistaRegistro extends javax.swing.JFrame {
    
    ControladorRegistro controlRegistro;
    
    public VistaRegistro() {
        initComponents();
        this.controlRegistro = new ControladorRegistro(this);
    }
    ...
    private void initComponents() {
        ...
        bnRegistrar.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
    ...
    private void bnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnRegistrarActionPerformed
        this.controlRegistro.accionIngresar();
    ...
    private void bnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnRegresarActionPerformed
        this.controlRegistro.accionRetroceder();
